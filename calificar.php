...
if (isset($num) && $num) {
  ...
  <div class="container" style="padding:20px;margin-top:5px">
    <h2 class="mt-4">Mostrando la Prueba # <?= escapar($num['id'])?></h2>
    <hr>
  </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <section class="col-lg-5 connectedSortable">
        <form>
          <input type="button" value="Imprimir Resultados" class="" onClick="window.print()" class="btn btn-primary mt-4">
        </form>
        ...
        <?php
          ...
          echo "Edad del paciente: ".$intervalo->y . " años, " . $intervalo->m." meses, ".$intervalo->d." dias, " . $intervalo->h . " horas, " . $intervalo->i . " minutos y " . $intervalo->s . " segundos";
