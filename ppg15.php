  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar15.php'>
          <!-- Tétadra -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 15</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Es capaz de conseguir que los demás cambien de opinión.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>No le interesa unirse a las actividades de un grupo.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Es un individuo bastante nervioso.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Es muy constante en cualquier tarea que se ha emprendido.</td>
              <td>
                <div class="col-md-13">
