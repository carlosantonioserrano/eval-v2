  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar37.php'>
          <!-- Tétadra -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 37</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Confía mucho en los demás.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>Prefiere los trabajos rutinarios y sencillos.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Hace las cosas 'de golpe'.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Rebosa vitalidad y energía.</td>
              <td>
                <div class="col-md-13">
