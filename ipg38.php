  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar38.php'>
          <!-- Tétadra #1 -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 38</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Toma decisiones con demasiada rapidez.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>Cualquier persona le cae bien.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Mantiene un ritmo activo, tanto en el trabajo como en el juego.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>No tiene un gran interés por aprender cosas nuevas.</td>
              <td>
                <div class="col-md-13">
