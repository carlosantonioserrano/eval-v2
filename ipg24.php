  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar24.php'>
          <!-- Tétadra -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 24</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Es una persona a la que le gusta ‘probar fortuna’.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>Se enfada con otros con bastante facilidad.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Consigue hacer muchas cosas en poco tiempo.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Pasa bastante tiempo elaborando nuevas ideas.</td>
              <td>
                <div class="col-md-13">
