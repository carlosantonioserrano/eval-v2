  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar17.php'>
          <!-- Tétadra -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 17</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Se puede confiar plenamente en él.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>No le gusta la compañía de la mayoría de la gente.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Resulta difícil estar tranquilo.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Toma parte activa en las decisiones del grupo.</td>
              <td>
                <div class="col-md-13">
