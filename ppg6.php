  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar6.php'>
          <!-- Tétadra -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 6</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>No le interesa demasiado relacionándose con los demás.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>No asume responsabilidades con seriedad.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>En todo momento se siente seguro de sí mismo y sereno.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Asume la dirección en actividades de grupo.</td>
              <td>
                <div class="col-md-13">
