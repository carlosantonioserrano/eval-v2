  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar36.php'>
          <!-- Tétadra #1 -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 36</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Es capaz de realizar más cosas que los demás.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>Le gusta aventurarse sólo por lo que tiene de diversión.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Le molesta que le critiquen.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Le gusta más trabajar con ideas que con objetos.</td>
              <td>
                <div class="col-md-13">
