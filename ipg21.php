  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar21.php'>
          <!-- Tétadra #1 -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 21</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Es una persona muy activa.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>No se enfada con nadie.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>No le gusta trabajar en tareas complicadas y difíciles.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Prefiere fiestas movidas a reuniones tranquilas.</td>
              <td>
                <div class="col-md-13">
