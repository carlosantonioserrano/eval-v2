  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar10.php'>
          <!-- Tétadra #1 -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 10</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Se siente seguro en sus relaciones con los demás.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>Sus sentimientos son heridos con facilidad.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Sus hábitos de trabajo están bien desarrollados.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Prefiere estar con un grupo reducido de amigos.</td>
              <td>
                <div class="col-md-13">
