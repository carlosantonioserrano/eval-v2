      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 2</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>No le interesa relacionarse con los demás.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>Es una persona sin tensiones ni ansiedad.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>No es muy digno de confianza.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>En las discusiones de grupo lleva la iniciativa.</td>
              <td>
                <div class="col-md-13">
