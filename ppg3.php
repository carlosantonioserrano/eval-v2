      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <table class="default" width="40%" align="center">
            ...
            <tr>
              <td><strong>B. </strong>Tiene mucha influencia sobre los demás.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>No le gustan las relaciones sociales.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Trabaja de un modo muy constante y tenaz.</td>
              <td>
                <div class="col-md-13">
