        ...
        <div class="card card-default">
          ...
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Es un individuo con mucha paciencia.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>Busca lo interesante y lo apasionante.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Es capaz de estar trabajando mucho tiempo seguido.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Le gusta más llevar a cabo un proyecto que planearlo.</td>
              <td>
                <div class="col-md-13">
