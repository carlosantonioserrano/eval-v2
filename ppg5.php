  ...
  <h1 align="center">Prueba PPG-IPG</h1><br>
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Formulario -->
        <form method="post" action='enviar5.php'>
          <!-- Tétadra #1 -->
        <div class="card card-default">
          <div class="card-header">
            <label align="center" background="blue">Grupo 5</label>
          </div>
          <div class="card-body">
          <table class="default" width="40%" align="center">
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>A. </strong>Es capaz de tomar decisiones importantes sin la ayuda de nadie.</td>
              <td>
                <div class="col-md-13">
            ...
            <tr>
              <td><strong>B. </strong>Le resulta difícil desenvolverse con soltura ante desconocidos.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr style="background-color: rgb(152, 200, 255);">
              <td><strong>C. </strong>Tiende a sentirse incómodo y en tensión.</td>
              <td>
              <div class="col-md-13">
            ...
            <tr>
              <td><strong>D. </strong>Termina su trabajo a pesar de las dificultades.</td>
              <td>
                <div class="col-md-13">
